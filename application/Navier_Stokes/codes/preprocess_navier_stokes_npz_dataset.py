...
DEFAULT_TRAIN_ROOT = (
    GOAM_CLEAN_ROOT
    / "Example"
    / "Navier_Stokes_Re=100"
    / "tmpdirectory"
    / "Navier_Stokes_Re_100_trainsize_896_threads_112"
)
...
def main() -> None:
    run_cli(
        GoamChunkNpzDefaults(
            ...
            test_root=DEFAULT_TRAIN_ROOT,
            output_root=DEFAULT_OUTPUT_ROOT,
            dataset_kind="navier_stokes_re100_goam_chunk_npz",
            sample_prefix="ns_re100",
            qoi_stride=1,
        ),
        description="Convert GOAM Navier-Stokes chunk .npz files into GOATTM manifest format.",
    )
