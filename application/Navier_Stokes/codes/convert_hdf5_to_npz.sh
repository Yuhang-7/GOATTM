...
INPUT_FILE="${INPUT_FILE:-${GOAM_CLEAN_ROOT}/Example/Navier_Stokes_Re=100/dataset/latent_data_1000_Re=100.hdf5}"
TRAIN_COUNT="${TRAIN_COUNT:-896}"
TEST_COUNT="${TEST_COUNT:-104}"
