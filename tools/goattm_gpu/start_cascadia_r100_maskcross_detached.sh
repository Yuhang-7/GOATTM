...
OUT=/global/homes/y/yuuuhang/quad_goattm/outputs/cascadia_packed8192_r100_dissskewA20_energytucker50tt16_maskcross2000_lbfgs_wolfe_reset10_40steps_detached_node1024
mkdir -p "$OUT"
