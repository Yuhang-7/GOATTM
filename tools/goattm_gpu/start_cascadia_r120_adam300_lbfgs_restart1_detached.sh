...
OUT=/global/homes/y/yuuuhang/quad_goattm/outputs/cascadia_packed8192_r120_dissskewA20_shift1_energytucker40tt40_maskcross2000_adam300_lbfgs_wolfe_reset10_restart1_80steps_node1024
mkdir -p "$OUT"
